		...
		<div class="container position-relative">
			<div class="row d-flex justify-content-center">
				<div class="col-lg-6 text-center">
					<h2>About</h2>
					<a class="cta-btn" href="javascript:alert('contact me!')">Available for hire</a>
				</div>
			</div>
		</div>
	</div>
	...
	<section id="about" class="about">
		<div class="container">
			...
			<div class="row gy-4 justify-content-center">
				<div class="col-lg-4">
					<img src="/resources/guest/img/profile.jpg" class="img-fluid" alt="">
				</div>
				<div class="col-lg-5 content">
					<h2>Back-end Web Developer from Seoul, Korea</h2>
					<p class="fst-italic py-3">
						밝고 에너지 넘치는 java & Spring MVC 프레임워크 기반 웹 백엔드 개발자입니다.
						소상공인을 위한 인사 관리 프로그램(HRM Service)을 구축하고 싶다는 목표를 가지고 개발 공부를
						시작했습니다. 목표를 위해 배움에 게을리하지 않고 성실하게 노력해 기술을 통해 가치를 구현하겠습니다.
					</p>
					<div class="row">
						<div class="col-lg-6">
							<ul>
								<li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong>
									<span>17 July 1993</span></li>
								<li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
									<span>www.example.com</span></li>
								<li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong>
									<span>+82 10 9248 ****</span></li>
								<li><i class="bi bi-chevron-right"></i> <strong>City:</strong>
									<span>Seoul, Republic of Korea</span></li>
							</ul>
						</div>
						<div class="col-lg-6">
							<ul>
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="testimonial-item">
							...
							<div class="profile mt-auto">
								<img src="/resources/guest/img/testimonials/testimonials-1.jpg"
					...
					<div class="swiper-slide">
						<div class="testimonial-item">
							...
							<p>Export tempor illum tamen malis malis eram quae irure esse
								labore quem cillum quid cillum eram malis quorum velit fore eram
								velit sunt aliqua noster fugiat irure amet legam anim culpa.</p>
							<div class="profile mt-auto">
								<img src="/resources/guest/img/testimonials/testimonials-2.jpg"
									class="testimonial-img" alt="">
								<h3>Sara Wilsson</h3>
								<h4>Designer</h4>
							</div>
					...
					<div class="swiper-slide">
						<div class="testimonial-item">
							...
							<p>Enim nisi quem export duis labore cillum quae magna enim
								...
								duis noster aute amet eram fore quis sint minim.</p>
							<div class="profile mt-auto">
								<img src="/resources/guest/img/testimonials/testimonials-3.jpg"
									class="testimonial-img" alt="">
								<h3>Jena Karlis</h3>
								<h4>Store Owner</h4>
							</div>
					...
					<div class="swiper-slide">
						<div class="testimonial-item">
							...
							<p>Fugiat enim eram quae cillum dolore dolor amet nulla culpa
								multos export minim fugiat minim velit minim dolor enim duis
								veniam ipsum anim magna sunt elit fore quem dolore labore illum
								veniam.</p>
							<div class="profile mt-auto">
								<img src="/resources/guest/img/testimonials/testimonials-4.jpg"
									class="testimonial-img" alt="">
								<h3>Matt Brandon</h3>
								<h4>Freelancer</h4>
							</div>
					...
					<div class="swiper-slide">
						<div class="testimonial-item">
							...
							<p>Quis quorum aliqua sint quem legam fore sunt eram irure
								...
								nisi cillum quid.</p>
							<div class="profile mt-auto">
								<img src="/resources/guest/img/testimonials/testimonials-5.jpg"
									class="testimonial-img" alt="">
								<h3>John Larson</h3>
								<h4>Entrepreneur</h4>
							</div>
